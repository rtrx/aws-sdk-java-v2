...
public final class StaticAttribute<T, R> {
     ...
     * @param attributeType A {@link TypeToken} that represents the type of the value this attribute stores.
     * @return A new typed builder for an attribute.
     */
    public static <T, R> Builder<T, R> builder(Class<T> itemClass, TypeToken<R> attributeType) {
    ...
    public static <T, R> Builder<T, R> builder(Class<T> itemClass, Class<R> attributeClass) {
        return new Builder<>(TypeToken.of(attributeClass));
    }
    ...
    /**
     * A {@link TypeToken} that represents the type of the value this attribute stores.
     */
    ...
    public static final class Builder<T, R> {
        ...
        private Builder(TypeToken<R> type) {
            this.type = type;
        }
